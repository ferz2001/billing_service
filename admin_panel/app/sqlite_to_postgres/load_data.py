...
if __name__ == '__main__':
    ...
    db_conf = {
        'dbname': os.environ.get('ADMIN_PANEL_POSTGRES_DB'),
        'user': os.environ.get('ADMIN_PANEL_POSTGRES_USER'),
        'password': os.environ.get('ADMIN_PANEL_POSTGRES_PASSWORD'),
        'host': os.environ.get('ADMIN_PANEL_POSTGRES_HOST', '127.0.0.1'),
        'port': os.environ.get('PADMIN_PANEL_OSTGRES_PORT', 5432),
    }
